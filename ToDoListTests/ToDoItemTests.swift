...
final class ToDoItemTests: XCTestCase {
    ...
    func test_ParseJson() throws {
        ...
        let todoItemHelper2 = TodoItem(id: "1", text: "тест", importance: .normal, dateСreation: Date(timeIntervalSince1970: 1100133188.0))
    ...
    func test_JsonCheckDates() throws {
        ...
        let todoItemJsonHelper = TodoItem(text: "тест", importance: .normal, dateDeadline: Date(timeIntervalSince1970: 1100133188), dateСreation: Date(timeIntervalSince1970: 1100133188), dateChanging: Date(timeIntervalSince1970: 1100133188)).json as! [String: Any]
    ...
    func test_CsvNotOrdinaryImportance() {
        ...
        let todoItemCsvHelper1 = TodoItem(id: "1", text: "тест", importance: .normal, isDone: false, dateСreation: Date(timeIntervalSince1970: 1100133188.0)).csv
        let todoItemCsvHelper2 = TodoItem(id: "2", text: "тест", importance: .important, isDone: false, dateСreation: Date(timeIntervalSince1970: 1100133188.0)).csv
        let todoItemCsvHelper3 = TodoItem(id: "3", text: "тест", importance: .unimportant, isDone: false, dateСreation: Date(timeIntervalSince1970: 1100133188.0)).csv
    ...
    func test_CsvCheckDates() throws {
        ...
        let todoItemCsvHelper = TodoItem(id: "1", text: "тест", importance: .normal, dateDeadline: Date(timeIntervalSince1970: 1100133188), isDone: false, dateСreation: Date(timeIntervalSince1970: 1100133188), dateChanging: Date(timeIntervalSince1970: 1100133188)).csv
